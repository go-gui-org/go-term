...
[`go-gui`](https://github.com/go-gui-org/go-gui) framework. Spawns a real shell
...
[`scripts/shell-integration/`](scripts/shell-integration) — and add one line to
your rc file:
...
[docs/fixture-capture.md](docs/fixture-capture.md) for capturing a real terminal
